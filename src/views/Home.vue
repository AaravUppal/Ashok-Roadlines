<template>
  <div class="min-h-screen bg-white overflow-x-hidden">
      ...
      >
        <transition-group name="hero-fade">
          ...
          >
            ...
            <div
              v-else
              class="absolute inset-0 w-full h-full bg-cover bg-center brightness-50"
        ...
        <div class="container mx-auto">
          <transition name="hero-content" mode="out-in">
            <div :key="currentSlide" class="max-w-5xl mx-auto text-center">
              ...
              <h1 class="text-4xl sm:text-6xl md:text-8xl font-black text-white mb-6 leading-tight">
                {{ heroSlides[currentSlide].title }}
              </h1>
              
              <p class="text-base sm:text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
    ...
    <div class="bg-white">
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-12 md:mb-16 relative z-10 scroll-reveal">
              <div class="inline-flex items-center gap-2 mb-4">
                ...
                <span class="text-xs sm:text-sm uppercase tracking-widest text-[#A85750] font-bold">
                  Our Story
                </span>
                <div class="w-8 h-px bg-[#A85750]"></div>
              </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              >
                <div class="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-xl mb-4
                ...
                <h3 class="text-lg md:text-xl font-black mb-2 md:mb-3 relative z-20 text-white">
                  {{ card.title }}
                </h3>
                <p class="text-xs sm:text-sm leading-relaxed relative z-20" 
      ...
      <!-- Services Section -->
      <section id="services" ref="servicesSection" class="py-16 md:py-20 bg-gray-50 relative">
        <div class="container mx-auto px-6">
              ...
              >
                ...
                <div class="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-xl mb-4
                  ...
                  <i :class="service.icon" 
                     class="text-2xl md:text-3xl text-[#A85750] group-hover:text-white 
                            transition-colors duration-500"></i>
                </div>

                <h3 class="text-base md:text-lg font-black text-gray-900 mb-2 
      ...
      <!-- Industry Sectors -->
      <section ref="sectorsSection" class="py-16 md:py-20 bg-gray-900">
        <div class="container mx-auto px-6">
          <div class="text-center mb-10 md:mb-12 scroll-reveal">
            <h3 class="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-2">Industry Sectors</h3>
            <p class="text-base sm:text-lg text-gray-400">Trusted across critical infrastructure domains</p>
          </div>
          
          <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 md:gap-6 max-w-5xl mx-auto">
            <div 
              ...
              :style="{ transitionDelay: `${index * 100}ms` }"
            >
              <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full border-2 border-white/10
                          group-hover:border-[#A85750] group-hover:scale-110
                          transition-all duration-500 flex items-center justify-center
                          bg-white/5 group-hover:bg-[#A85750] relative overflow-hidden">
                <i :class="sector.icon" 
                   class="text-2xl sm:text-3xl text-[#A85750] group-hover:text-white 
                          transition-colors duration-500 relative z-20"></i>
              </div>
              
              <p class="text-[10px] sm:text-xs md:text-sm uppercase tracking-wider text-gray-400 mt-3
...
const onTouchMove = (e) => {
  if (!isSwiping.value || !e.touches || e.touches.length === 0) return
...
onMounted(() => {
  ...
  // Setup scroll reveal after a small delay to ensure DOM is ready
  setTimeout(() => {
    setupScrollReveal()
  }, 100)
})
